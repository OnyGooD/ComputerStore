document.addEventListener("DOMContentLoaded", () => {
    const products = [
        ...
        { id: 9, name: "Samsung Smart Monitor M5 27\"", type: "Samsung", shortDesc: "Okos funkciók, munkához", longDesc: "A Samsung Smart Monitor M5 ideális mindennapi használatra és home office feladatokhoz. Full HD felbontásával és beépített okos funkcióival TV-ként is használható.", image: "images/samsung4.png", price: "78 500 Ft" },
        { id: 10, name: "LG 32UN500-W 4K UHD", type: "LG", shortDesc: "Nagy felbontás, színgazdag", longDesc: "Az LG 32UN500-W monitor 4K UHD felbontást és HDR10 támogatást kínál, amely éles képet és élénk színeket biztosít, kiváló munkavégzéshez és multimédiához.", image: "images/lg4.png", price: "129 900 Ft" },
        { id: 11, name: "Acer Nitro XV282K", type: "Acer", shortDesc: "4K játékos monitor", longDesc: "Az Acer Nitro XV282K egy nagy felbontású 4K monitor, 144Hz-es frissítéssel és FreeSync technológiával. Tökéletes választás játékosoknak, akik a legjobb képminőséget keresik.", image: "images/acer3.png", price: "199 900 Ft" },
        { id: 12, name: "Samsung Odyssey Neo G9", type: "Samsung", shortDesc: "Széles ívelt látvány", longDesc: "A Samsung Odyssey Neo G9 egy ultrawide, ívelt monitor 5120x1440 felbontással és HDR1000 támogatással. Egyedülálló játékélményt nyújt, lenyűgöző látványvilággal.", image: "images/samsung5.png", price: "549 900 Ft" }
    ];
